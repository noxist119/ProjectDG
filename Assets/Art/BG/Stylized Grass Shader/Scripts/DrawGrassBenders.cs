                    ...
                    foreach (KeyValuePair<int, List<GrassBender>> layer in StylizedGrassRenderer.GrassBenders)
                    {
                        foreach (GrassBender b in layer.Value)
                        {
                            ...
                            if (b.benderType == GrassBenderBase.BenderType.ParticleSystem)
                            {
                                ...
                                m_ParticleRenderer.BakeMesh(b.bakedMesh, renderingData.cameraData.camera, ParticleSystemBakeMeshOptions.Default);
                                ...
                                if (b.hasParticleTrails)
                                {
                                    ...
                                    m_ParticleRenderer.BakeTrailsMesh(b.particleTrailMesh, renderingData.cameraData.camera, ParticleSystemBakeMeshOptions.Default);
