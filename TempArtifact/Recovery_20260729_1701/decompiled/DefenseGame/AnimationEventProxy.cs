...
public class AnimationEventProxy : MonoBehaviour
{
	...
	{
		UnitAnimationDriver unitAnimationDriver = ResolveDriver();
		object result;
		if (!((Object)(object)unitAnimationDriver == (Object)null))
		{
			if (!((Object)(object)cachedMaterialController != (Object)null))
			{
				AnimationMaterialOverrideController obj = ((Component)unitAnimationDriver).GetComponent<AnimationMaterialOverrideController>() ?? ((Component)unitAnimationDriver).gameObject.AddComponent<AnimationMaterialOverrideController>();
	...
	{
		if ((Object)(object)cachedDriver == (Object)null)
		{
			cachedDriver = ((Component)this).GetComponentInParent<UnitAnimationDriver>();
		}
		return cachedDriver;
	}
}
