	...
	public class TextMeshProFloatingText : MonoBehaviour
	{
		...
		private void Start()
		{
			if (SpawnType == 0)
			{
				...
				((Graphic)m_textMeshPro).color = new Color32((byte)Random.Range(0, 255), (byte)Random.Range(0, 255), (byte)Random.Range(0, 255), byte.MaxValue);
		...
		public IEnumerator DisplayTextMeshProFloatingText()
		{
			...
			Color32 start_color = ((Graphic)m_textMeshPro).color;
			float alpha = 255f;
			...
			while (current_Count > 0f)
			{
				...
				((Graphic)m_textMeshPro).color = new Color32(start_color.r, start_color.g, start_color.b, (byte)alpha);
