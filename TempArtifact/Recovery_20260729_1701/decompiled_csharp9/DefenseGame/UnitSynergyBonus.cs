...
namespace DefenseGame
{
	...
	public struct UnitSynergyBonus
	{
		...
		public bool HasAnyValue => Math.Abs(attackPowerBonus) > 0.0001f || Math.Abs(attackSpeedBonus) > 0.0001f || Math.Abs(critChanceBonus) > 0.0001f || Math.Abs(rangeBonus) > 0.0001f || Math.Abs(manaRegenRateBonus) > 0.0001f || Math.Abs(maxHealthBonus) > 0.0001f || Math.Abs(splashRadiusBonus) > 0.0001f || Math.Abs(splashDamageRatioBonus) > 0.0001f || Math.Abs(skillPowerBonus) > 0.0001f || Math.Abs(criticalDamageBonus) > 0.0001f || Math.Abs(bossDamageBonus) > 0.0001f || Math.Abs(damageReductionBonus) > 0.0001f || Math.Abs(manaGainWhenHitRateBonus) > 0.0001f || Math.Abs(manaGainPerAttackRateBonus) > 0.0001f;
